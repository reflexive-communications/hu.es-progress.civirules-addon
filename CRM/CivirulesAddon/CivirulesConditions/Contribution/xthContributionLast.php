...
class CRM_CivirulesAddon_CivirulesConditions_Contribution_xthContributionLast extends CRM_CivirulesConditions_Contribution_xthContribution
{
    ...
    public function isConditionValid(CRM_Civirules_TriggerData_TriggerData $triggerData)
    {
        ...
        try {
            ...
            Civi::log()->error(
                ts('Unexpected error from API Contribution getcount in ').__METHOD__
    ...
    public function userFriendlyConditionParams()
    {
        ...
        return ts('Number of contributions in the last ').
            $this->_conditionParams['interval'].' '.$intervals[$this->_conditionParams['interval_unit']].' of financial type '.implode(
                ' or ',
                $finTypesTxt
            )
